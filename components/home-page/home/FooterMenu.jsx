...
const footerData = [
  {
    ...
    links: [
      { label: "Home", href: "/" },
      { label: "Über", href: "/pages-menu/pricing" },
      { label: "Leistungen", href: "/pages-menu/about-us-v1" },
      { label: "Portfolio", href: "/blog/blog-v2" },
      { label: "Kontakt", href: "/pages-menu/service-v1" },
  ...
  },
  {
    ...
    links: [
      { label: "Nutzungserklärung", href: "/pages-menu/faq" },
      { label: "Geschäftsbedingungen", href: "/pages-menu/faq" },
      { label: "Datenschutzbedingungen", href: "/pages-menu/faq" },
      { label: "Cookie-Richtlinien", href: "/pages-menu/faq" },
      { label: "Impressum", href: "/pages-menu/faq" },
